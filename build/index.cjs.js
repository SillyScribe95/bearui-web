...
function moveItemFront(listo, itemo) {
  const jsdas = lodash.sortBy(listo, ({
    type
  }) => type === itemo ? 0 : 1);
  return jsdas;
}
...
function removeArray(array, obj, attr) {
  ...
  let okdsasd = lodash.filter(array, baseRem); // remove(
  return okdsasd;
}
function filterDictArray(myArr, sdofkewr) {
  const okada = lodash.filter(myArr, sdofkewr);
  return okada;
}
...
function checkFullArray(arrBig, arrSmall) {
  let okasdw = !lodash.isEmpty(removeEmptyArray(arrBig));
  return okasdw;
}
...
function BearFloat({
  ...
  const lefto = sasease && /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement("div", jndf, left), !noSpace && /*#__PURE__*/React__default['default'].createElement(react.Spacer, null));
  const kdsdf = { ...centerConfig // style: { textAlign: "center", ...centerConfig.style },

  };
  const centio = /*#__PURE__*/React__default['default'].createElement("div", kdsdf, center || children);
  const ijsad = {
    marginLeft: "auto",
    style: alignTrue && {
      textAlign: "right"
  ...
  const rightos = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, !noSpace && /*#__PURE__*/React__default['default'].createElement(react.Spacer, null), /*#__PURE__*/React__default['default'].createElement("div", ijsad, right)); // position: "absolute",
  ...
  function eqweew(itemo, {
    ...
    const ijsdf = /*#__PURE__*/React__default['default'].createElement(BearDiv$1, asoke, itemo);
    return ijsdf;
  }

  const sokwerr = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, sfewr(topLeft, topLeftConfig, {
    top: paddingVert,
    left: paddingHorz
  ...
  const ksaewe = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, lefto, sokwerr, rightos);
  let endValue = "";
...
function BearButton({
  ...
  const aisjqw = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, qy7eww); // const xcvfdc = {
  //   borderRadius:
  //   ...style
  // }
  ...
  const sfdsgwe = groupConfig ? /*#__PURE__*/React__default['default'].createElement(GroupBase, groupConfig) : /*#__PURE__*/React__default['default'].createElement("button", sfasdokwe, aisjqw) // <button {...sfasdokwe}>{aisjqw}</button>
  ;
  const jawewe = { ...arg,
    obj: sfdsgwe,
    link,
  ...
  const pdska = downloadLink ? /*#__PURE__*/React__default['default'].createElement("a", {
    href: downloadLink,
    download: true
  }, asdgvwe) : asdgvwe;
  return pdska;
...
function BearErASDJIQWE(asdfower, {
  ...
  // 1const
  const ijsawe = asdfower && /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement("br", null), /*#__PURE__*/React__default['default'].createElement("br", null), asdfower);
  const sidjfr = hideError && /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement("br", null), /*#__PURE__*/React__default['default'].createElement("br", null), BearHideError(hideError, bearName));
  const okfdsd = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, "\uD83D\uDC3B ERROR", ijsawe, sidjfr, /*#__PURE__*/React__default['default'].createElement("br", null), /*#__PURE__*/React__default['default'].createElement("br", null));
  const ijsad = {
    //
    // width: "100%",
    padding: "5px 20%",
  ...
  const okasew = /*#__PURE__*/React__default['default'].createElement(BearDiv$1, adkease);
  return okasew;
}
function BearHideError(attr, name) {
  const isjdfre = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, "To hide this error, set ", BearQuote(attr), " as true in ", BearQuote(name), "s", " ", "arguments.");
  return isjdfre;
...
function BearIcon(sdfoger, sdfke) {
  ...
  //
  // <TiTickOutline />
  React__default['default'].createElement(fa.FaCheck, lasew) // <AiOutlineCheckCircle {...lasew} />
  ; // 1signout
  ...
  /*#__PURE__*/
  //
  React__default['default'].createElement(ai.AiOutlineInfoCircle, null); // 1play
  ...
  //
  // <FiEdit2 />
  React__default['default'].createElement(bi.BiEditAlt, null) // <VscEdit />
  // <BiEdit />
  ; // 1star
  ...
  /*#__PURE__*/
  //
  React__default['default'].createElement(ai.AiOutlineSearch, null) // < />
  ; // 1settings

  const sdijwqe =
  /*#__PURE__*/
  //
  React__default['default'].createElement(fi.FiSettings, null); // 1email

  const ijsfr =
  /*#__PURE__*/
  //
  React__default['default'].createElement(ai.AiOutlineMail, null); // 1brands 1social

  const brandCons = {
    twitter: /*#__PURE__*/React__default['default'].createElement(si.SiTwitter, null),
    reddit: /*#__PURE__*/React__default['default'].createElement(si.SiReddit, null),
    ycombinator: /*#__PURE__*/React__default['default'].createElement(si.SiYcombinator, null),
    linkedin: /*#__PURE__*/React__default['default'].createElement(si.SiLinkedin, null),
    google: /*#__PURE__*/React__default['default'].createElement(si.SiGoogle, null),
    whatsapp: /*#__PURE__*/React__default['default'].createElement(si.SiWhatsapp, null),
    facebook: /*#__PURE__*/React__default['default'].createElement(si.SiFacebook, null),
  ...
  const ijsadwe = {
    // left: <
    // right:
    back: /*#__PURE__*/React__default['default'].createElement(md.MdArrowBack, null),
    forward: /*#__PURE__*/React__default['default'].createElement(md.MdArrowForward, null),
    info: jdfgrt,
    email: ijsfr,
    search: sdfgorek,
    signout: sduhfer,
    copy: /*#__PURE__*/React__default['default'].createElement(fa.FaCopy, null),
    expand: /*#__PURE__*/React__default['default'].createElement(bi.BiExpand, null),
    tick: okasdew,
    delete: asdfewr,
    playlist: asdkqe,
    settings: sdijwqe,
    share: sjerw,
    star: dfigjew,
    plus: /*#__PURE__*/React__default['default'].createElement(ai.AiOutlinePlus, null),
    comment: sowaseowq,
    link: linkios,
    play: sfdgmr,
    edit: sdiwer,
...
function BearImage({
  ...
  switch (typevar) {
    ...
    default:
      ...
      //
      // "sadwqe";
      React__default['default'].createElement("img", osdew) // <Avatar {...osdew} />
      ;
  }
...
function BearTextMedia({
  ...
  function ImgMain({ ...dsfew
    ...
    const oksaw = /*#__PURE__*/React__default['default'].createElement(BearImage, fnkfg);
    return oksaw;
  } // 1text
  ...
  const okdsre = okeasw ? /*#__PURE__*/React__default['default'].createElement(ImgMain, imageConfig) : "";
  const kadse = okdsre ? okdsre : iconvar && /*#__PURE__*/React__default['default'].createElement(INcoio, iconConfig);
  const textShow = !noText && !onlyIcons && textvar;
  const okdswq = textShow && /*#__PURE__*/React__default['default'].createElement(Ajiwq, textconfig);
  const okasew = {
    style: {
      margin: padvar
    }
  ...
  const oksaew = bothTrue && /*#__PURE__*/React__default['default'].createElement(BearDiv$1, _extends({
    span: true,
    ignoreNull: true
  }, okasew));
  ...
  function RendMain() {
    ...
    const oskdawe = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, lftoe, oksaew, righto);

    function Rendo() {
      const VCIFWRE = {
        obj: oskdawe
      };
      const fdghew = /*#__PURE__*/React__default['default'].createElement(BearDiv$1 //
      , _extends({
        flex: true,
        vertAlign: true
...
function BearListItemExpand(cvbokfe, dasfjewr, {
  ...
  switch (typeList) {
    ...
    case "return":
      asdpkwe = /*#__PURE__*/React__default['default'].createElement(BearDiv$1, _extends({}, endRet, {
        obj: listarr
      }));
      break;
    ...
    default:
      ...
      function findObjPress() {
        ...
        return trueGo ? /*#__PURE__*/React__default['default'].createElement(BearDiv$1, _extends({}, endRet, {
          obj: finLog(endRet)
        })) : BearError("must be a function, not " + jsdw);
      }

      asdpkwe = //
      findobj ? findObjPress() : !dictRet && /*#__PURE__*/React__default['default'].createElement(BearDiv$1, _extends({}, endRet, {
        obj: listarr
      }));
  } //
  ...
  const ijsew = //
  // "";
  lineBetween && /*#__PURE__*/React__default['default'].createElement("hr", null); // const saewe = origItem["title"] && titleTrue;
  // const sdijfw = saewe && <Tjisae {...origItem} />;
  // typeBullet =

  const ijdsasew = //
  !typeBullet ? auewasdash : /*#__PURE__*/React__default['default'].createElement("li", null, auewasdash);
  const asidjwe = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, ijdsasew, ijsew);
  return asidjwe;
}
...
function BearTitle({
  ...
  const aijsdwe = //
  ""; // "shadowBottom";
  const usdhfr = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, title, lineBetween && /*#__PURE__*/React__default['default'].createElement("hr", null));
  ...
  const oksd = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(BearDiv$1, titleConfig), subtitle && /*#__PURE__*/React__default['default'].createElement(BearDiv$1, sijwesae), belowObj);
  const iasjwe = {
    obj: oksd,
    style: {
      width: "100%"
...
function dfkbijv(named, children, {
  ...
  function Titoas({
    ...
    const noisae = /*#__PURE__*/React__default['default'].createElement(BearTitle, kjase);
    return noisae;
  } // 1title
  ...
  function Adverto({
    ...
    const xvbijewr = /*#__PURE__*/React__default['default'].createElement(BearDiv$1, _extends({
      span: true
    }, asqewew), "Built with love by", " ", /*#__PURE__*/React__default['default'].createElement(BearDiv$1, {
      span: true,
      className: "bold"
    }, "\uD83D\uDC3B Bear UI"));
    return xvbijewr;
  ...
  const dfsigwer = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, askew, children);
  const disjwe = {
  ...
  const ikjdwer = /*#__PURE__*/React__default['default'].createElement(BearFloat, jfdert, dfsigwer);
  const okfdsd = //
  ikjdwer; // dfsigwer;
  ...
  args = {
    obj: /*#__PURE__*/React__default['default'].createElement(BearDiv$1, {
      obj: okfdsd
    }),
    style: idfg,
    ...args
  ...
  function sajwae(sdfer) {
    ...
    const uhfgewq = goCHecko ? sdfer : /*#__PURE__*/React__default['default'].createElement(BearDiv$1, args);
    return uhfgewq;
  }
  ...
  function rendName() {
    ...
    // )
    ) : objRequre ? sajwae(BearErrMiss(objRequre, bearName, sdufdsf)) : objDegrade ? sajwae(degradMess()) : /*#__PURE__*/React__default['default'].createElement(BearDiv$1, args);
  }
...
// list,
{
  ...
  function xvcbmf() {
    ...
    function sfjsd(xcvkm) {
      ...
      return /*#__PURE__*/React__default['default'].createElement(BearDiv$1, kseasd, HozBar(xcvkm));
    }
  ...
  const sadfwe = //
  //
  selectableTrue ? /*#__PURE__*/React__default['default'].createElement(Seletio, null) : displayNumber ? ksajda() : horiz ? HozBar(list) : donelist(list);
  ...
  const saokwe = typeBullet ? /*#__PURE__*/React__default['default'].createElement("ul", null, sadfwe) : sadfwe;
...
function BearInputLabel({
  ...
  /*#__PURE__*/React__default['default'].createElement(BearDiv$1, _extends({
    span: true
  }, asdwe)); // 1info 1popup
  ...
  const ioakawe = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, okasde);
  ...
  function BswTi() {
    ...
    const dfigjrt = /*#__PURE__*/React__default['default'].createElement(BearDiv$1, cvobkof);
    const kcmdr = {
      center: ioakawe,
      right: dfigjrt
    };
  ...
  function Subtoter(asdxc) {
    ...
    const uiajwe = /*#__PURE__*/React__default['default'].createElement(BearDiv$1, okawe);
    return uiajwe;
  }

  const sdfgret = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, seokwer, ijawe);
  const kase = {
...
function BearInputBase(ujsdqwe, {
  ...
  function TitleOBbi({
    ...
    return /*#__PURE__*/React__default['default'].createElement(BearInputLabel, sdfkewr, label);
  }
  ...
  const oksdwqe = showTit && /*#__PURE__*/React__default['default'].createElement(TitleOBbi, saewase);
  const confijre = {
    size: "sm",
    type: "submit",
    obj: "YES"
  ...
  const jaewdsr = {
    right: /*#__PURE__*/React__default['default'].createElement(BearButton, confijre),
    center: ujsdqwe
  }; // rightSubmit = true;
  ...
  lineBelow && /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement("hr", null)); // 1error
  ...
  function ErroBase({
    ...
    return /*#__PURE__*/React__default['default'].createElement(BearDiv$1, difg, fjdgse);
  }

  const xcbmd = !hideError && ErroBase(errorConfig);
  const okaweasd = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, oksdwqe, /*#__PURE__*/React__default['default'].createElement("div", okdsae, asdijwe), xcbmd); // 1return

  const zxcvdf = sameLine ? /*#__PURE__*/React__default['default'].createElement(Flex, ijsa, okaweasd) : /*#__PURE__*/React__default['default'].createElement("div", ijsa, okaweasd);
  const kaosdew = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, zxcvdf);
  return kaosdew;
}
...
function BearMissing(attr, mainnum, aseqwe = "Your component") {
  ...
  const kdsdae = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, BearQuote(nisdfrw), "'s", BearSpace(BearQuote(attr)), "attribute is empty or missing.");
  const sadwew = //
  kdsdae;
  return sadwew;
}
...
function BearIconText(icon, text, osdfds) {
  ...
  const sadwew = /*#__PURE__*/React__default['default'].createElement(BearTextMedia, bodfg);
  return sadwew;
}
function linkBase(link, objvar, osdfds) {
  ...
  const sadwew = /*#__PURE__*/React__default['default'].createElement(BearDiv$1, dkfdsfre);
  return sadwew;
}
function BearWrap({
  elipsisTrue,
  ...
  const pksdf = /*#__PURE__*/React__default['default'].createElement("div", lokgos, obj);
  return pksdf; //
}
...
function BearLink(obj, link, ...sdsda) {
  ...
  const jksdrwa = /*#__PURE__*/React__default['default'].createElement(BearDiv$1, ksdase);
  return jksdrwa;
}
...
function ListReturn({ ...sae
  ...
  const sadwew = /*#__PURE__*/React__default['default'].createElement(BearList, _extends({
    returnTrue: true
  }, sae));
  return sadwew;
}
...
function BearFlex({
  ...
  function RendFlex() {
    ...
    const saijwe = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(BearDiv$1, sdijrwe), /*#__PURE__*/React__default['default'].createElement(BearDiv$1, ijasew));
    return saijwe;
  }

  const okdsse = list ? list.map(redndo) : /*#__PURE__*/React__default['default'].createElement(RendFlex, null);
  const vbdrewe = {
    obj: okdsse,
    flex: true,
    ...kdsse,
  ...
  const sadwew = /*#__PURE__*/React__default['default'].createElement(BearDiv$1, vbdrewe);
  return sadwew;
}
function FlexHorz({
  children,
  ...
  return /*#__PURE__*/React__default['default'].createElement(Stack, ijdrwer, children);
} // 1slider
...
function ImageAlign({
  ...
  //
  //
  const okswe = /*#__PURE__*/React__default['default'].createElement(ImageMain, imageConfig);
  argo = {
    mainObj: okswe,
    ...argo
  };
...
function ImageGroup({
  ...
  // max size
  const sadwew = /*#__PURE__*/React__default['default'].createElement(AvatarGroup, sae, list.map(asowe => /*#__PURE__*/React__default['default'].createElement(ImageMain, _extends({
    typevar: "chakra"
  }, asowe))));
  return sadwew;
}
...
function LoadMain({
  ...
  switch (typevar) {
    ...
    default:
      endValue = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null);
  }
...
function BearSpace(dataVar, asdwe) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(BearSpan, kmxvs);
}
...
function SwitchLayout({
  ...
  const zxcmsd = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, "Hello!");
  const kmxvs = {
    obj: zxcmsd,
    style: skdfsa
  };
...
function BearBackForward({
  ...
  const uawhe = {
    // iconvar
    obj: /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, xcijsdf, children, dfgkmre),
  ...
  const ijwqeq = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(BearDiv$1, _extends({
    flex: true,
    vertAlign: true
  }, uawhe)));
  return ijwqeq;
...
function BearButtonDownload({
  ...
  const okfdsd = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, "sssss");
  args = {
    obj: okfdsd,
    onClick: downlood,
    ...args
  };
  return /*#__PURE__*/React__default['default'].createElement(BearButton, args);
}
...
function BearEmoji({
  ...
  function saokde({
    ...
    return /*#__PURE__*/React__default['default'].createElement(BearDiv$1, oksaew); // return <BearPopover {...aokdwe} />;
  }
...
function BearTags({
  ...
  function rendios(itemo) {
    ...
    const djfwer = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, "# ", itemo);
    const oksdewqsa = {
      className: "shadowHover",
      style: kasde,
      obj: djfwer,
    ...
    return /*#__PURE__*/React__default['default'].createElement(BearButton, oksdewqsa);
  }
...
function ProvideMain({
  ...
  let asijew = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, children);
  asijew =
  /*#__PURE__*/
  // !chakra. ? (
  //   asijew
  // ) : (
  React__default['default'].createElement(react.ChakraProvider, null, children);
  return asijew;
}

function BearContextProvider({ ...dsfer
}) {
  const sidjfewr = /*#__PURE__*/React__default['default'].createElement(ProvideMain, dsfer);
  const jads = //
...
function BearModal({
  ...
  React__default['default'].useRef(); // 1footer
  // 1antd
  ...
  const okfdsd = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(react.Modal, sirew, children)); //   args = {
  //     obj: okfdsd,
  //     ...args,
  //   };
  //   return "sdoksdf0";
...
function BearModalWarning({
  ...
  const cvofdd = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(BearDiv$1, dfigjrt, message), /*#__PURE__*/React__default['default'].createElement(BearButtonList, cvxbfdg));
  const ijfgr = {
    style: {
      textAlign: "center",
      fontSize: "20px",
  ...
  //
  // cvofdd;
  React__default['default'].createElement("div", ijfgr, " ", cvofdd); //   buttonConfig = {
  //   }
  ...
  return /*#__PURE__*/React__default['default'].createElement(BearModal, args, okfdsd);
}
...
function BearWarnDelete({
  ...
  const zxcmsd = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(Modska, null), /*#__PURE__*/React__default['default'].createElement(BearDiv$1, ijsdfer, children));
  return zxcmsd;
} // // 1back 1forward
...
function BearModel({
  ...
  // 1const
  const okfdsd = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, children);
  ...
  function asdsade(asdf) {
    ...
    return /*#__PURE__*/React__default['default'].createElement(BearWarnDelete, dhfgr, asdf);
  }
  ...
  const ijdwer = /*#__PURE__*/React__default['default'].createElement(BearList, isdre);
  args = {
    center: okfdsd,
    // right: ijdwer,
    [buttonLayout]: ijdwer,
  ...
  return /*#__PURE__*/React__default['default'].createElement(BearFloat, args);
}
...
function RendGroup(center, {
  ...
  const leftRendos = inputLeft && /*#__PURE__*/React__default['default'].createElement(react.InputLeftElement, leftConfig, inputLeft);
  const rightRendos = inputRight && /*#__PURE__*/React__default['default'].createElement(react.InputRightElement, rightConfig, inputRight);
  const sdijfr = inputRight || inputLeft;
  const sdresar = {//
  };
  const cvdfsoe = sdijfr ? /*#__PURE__*/React__default['default'].createElement(react.InputGroup, sdresar, leftRendos, center, rightRendos) : center;
...
function BearFormButton({
  ...
  // 1const
  /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, "sssss");
  args = { // obj: okfdsd,
    ...args
  };
  return /*#__PURE__*/React__default['default'].createElement("button", args, children);
}
...
function BearPassword({
  ...
  //
  // 1const
  const [strenghBase, setstrenghBase] = React.useState();
  ...
  function StrenchBarro(sdfgret) {
    ...
    const isdjfr = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(BearButton, sdersd, sdersd["text"]));
    const dfbdft = {
      flex: true
    };
    return /*#__PURE__*/React__default['default'].createElement(BearDiv$1, dfbdft, isdjfr);
  }
  ...
  function InRead(sdfgoekse) {
    ...
    const nsdijfe = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, sdfgoekse, /*#__PURE__*/React__default['default'].createElement(BearDiv$1, uhdfgr));
    return /*#__PURE__*/React__default['default'].createElement(BearDiv$1, {
      vertAlign: true,
      flex: true
    }, nsdijfe);
  } // function aidjew(){
  ...
  const ijvsf = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(BearFormButton, sdjfewr, isjda));
...
function BearCheckbox({
  ...
  const jidfrte = false;
  const [checkedItems, setCheckedItems] = React__default['default'].useState(jidfrte); // const allChecked = checkedItems.every(Boolean)
  ...
  function adfkwer() {
    ...
    return /*#__PURE__*/React__default['default'].createElement(BearDiv$1, difjrt, checkMessage);
  }

  const ijsf = checkedItems && checkMessage && adfkwer(); // onChange={(e) => setCheckedItems([e.target.checked, e.target.checked])}
  const ijsdr = /*#__PURE__*/React__default['default'].createElement(FlexHorz, {
    horiz: true
  }, ijsf); // 1console

  const vobkdf = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, ijsdr);
  return vobkdf;
}
...
function BearInputNumber({
  ...
  const nsidjer = step && /*#__PURE__*/React__default['default'].createElement(react.NumberInputStepper, idfjew, /*#__PURE__*/React__default['default'].createElement(react.NumberIncrementStepper, null), /*#__PURE__*/React__default['default'].createElement(react.NumberDecrementStepper, null));
  const serhhee = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(react.NumberInput, sfijwer, /*#__PURE__*/React__default['default'].createElement(react.NumberInputField, null), nsidjer)); // return serhhee;
...
function BearFormInputCheck({
  ...
  function goCont(funcPush, aisjdwe) {
    ...
    function inEar({
      ...
      const dfigjew = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, nfdgers);
      return dfigjew;
    }
...
function _dictMobile() {
  ...
  function asdwease(sdfwer) {
    ...
    const jsdfw = "+44";
    const sdifjer = /*#__PURE__*/React__default['default'].createElement(BearFormButton, sdjfewr, jsdfw);
    const ijsdsf = /*#__PURE__*/React__default['default'].createElement(layout.Flex, null, sdifjer, sdfwer);
    const dfjgr = //
    // sdfwer;
    ijsdsf;
    return dfjgr;
...
function BearForm({
  ...
  function Buttiona({
    ...
    const adhwdse = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement("button", dvbijkrw, text ? text : buttonText));
    return adhwdse;
  }
  ...
  function iasjdwe(obj) {
    ...
    const kadwesd = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, obj["tabTitle"]);
    return kadwesd;
  }
  ...
  function Tabios() {
    ...
    function aidsjfew({
      ...
      const lpsda = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(BearDiv$1, okawe), title);
    ...
    const okfdsd = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(BearList, asodwe));
    return okfdsd;
  } // 1map
  ...
  const sudhawe = topButtonTrue ? /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(Tabios, null), kaewsae) : kaewsae;
  /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, sudhawe);
  const iterwr = toplist;
  const mappit = iterwr ? /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, maperlis(toplist), /*#__PURE__*/React__default['default'].createElement("br", null), sudhawe) : /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, sudhawe);
  const aidjwe = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, topObj, mappit, betweenItem, buttio);
  const ijdfsr = //
  difjgr; // argPass

  const xcvsfs = loadSetto ? /*#__PURE__*/React__default['default'].createElement(LoadMain, loadConfig) : noForm ? aidjwe : /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement("form", ijdfsr, aidjwe));
  const nsdokfer = argPass(args);
  const isae = /*#__PURE__*/React__default['default'].createElement("div", nsdokfer, xcvsfs);
  const isjdwesdfoek = //   //
...
function BearFormList({
  ...
  function sdjfwer() {
    ...
    const ijdfges = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(BearDiv$1, fbjdfg, jdfwea));
...
function FormBase({ //
  ...
  const okfdsd = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement("form", cvkbdf, BearFormSetup(koerte), /*#__PURE__*/React__default['default'].createElement("button", kdfgr, "SUBMIT")));
  return okfdsd;
}
...
function BearAuthPortal({
  ...
  // sdfer;
  // setsignType = "";
  const [emaTrue, setemaTrue] = React.useState();
  const [sdfer, setsignType] = React.useState(typeSign);
  let signType = //
  typeSign; // sdfer;
  ...
  const EmailLoginButton = reactSocialLoginButtons.createButton(emaCon);
  const idfjgrt =
  /*#__PURE__*/
  ///
  React__default['default'].createElement(EmailLoginButton, null); // BearIconText("email", signCheck("Email"));
  ...
  const fdsogkret = {
    ...
    instagram: {
      textvar: /*#__PURE__*/React__default['default'].createElement(reactSocialLoginButtons.InstagramLoginButton, null, signCheck("Instagram"))
    },
    facebook: {
  ...
  function FOrnaW() {
    ...
    const forso = /*#__PURE__*/React__default['default'].createElement(BearForm, dfgre);
    return forso;
  }
  ...
  function OrCHekc() {
    ...
    const oksae = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(BearDiv$1, kasesd), /*#__PURE__*/React__default['default'].createElement(BearDiv$1, koewqe));
    const sdease = {
      obj: oksae,
      bediaTrue: true,
      style: {
    ...
    const kdsfse = /*#__PURE__*/React__default['default'].createElement(BearButton, sdease);
    const oasebd = {
      style: {
        paddingTop: "20px",
        textAlign: "center",
  ...
  const jdtre = sdfer && /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, jvsfeer, changeButton && /*#__PURE__*/React__default['default'].createElement(OrCHekc, null));
  const nsifjew = {
...
function BearSocialBase({
  ...
  // 1const
  React.useState("");
  const [cosNamB, setcosNamB] = React.useState();
  ...
  function iasjde({
    ...
    const gfnmeir = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(BearTextMedia, jsaease));
  ...
  const compBase = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(BearList, ijsadwe)); //
...
function BearSocialLinks({
  ...
  return /*#__PURE__*/React__default['default'].createElement(BearSocialBase, args);
}
...
function BearSocialShare({
  ...
  function NameSingio() {
    ...
    const vcbfd = /*#__PURE__*/React__default['default'].createElement(BearForm, okasew);
    return vcbfd;
  }

  const tkdf = nameTrue && /*#__PURE__*/React__default['default'].createElement(NameSingio, null);
  const compBase = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, tkdf, /*#__PURE__*/React__default['default'].createElement(BearSocialBase, ijsadwe)); //
...
exports.BearErrArgType = BearErrArgType$1;
exports.BearErrMiss = BearErrMiss;
exports.BearError = BearError;
exports.BearFalseLog = BearFalseLog;
exports.BearFlex = BearFlex;
exports.BearFloat = BearFloat;
exports.BearForm = BearForm;
exports.BearFormList = BearFormList;
...
exports.BearListComp = BearListComp;
