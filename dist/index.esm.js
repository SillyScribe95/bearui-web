...
import { SiMicrosoftteams, SiSlack, SiNotion } from 'react-icons/si';
import { AiOutlineCheckCircle, AiOutlineCloseCircle, AiFillDelete } from 'react-icons/ai';
...
function BearFloat(_ref) {
  ...
  switch (layoutType) {
    ...
    default:
      ...
      endValue = /*#__PURE__*/React.createElement(BearDiv, oesfdrtw);
  }
...
function BearButton(_ref) {
  ...
  var asdgvwe = asdijew ? /*#__PURE__*/React.createElement(BearDiv, jawewe) : sfdsgwe;
  ...
  var asdhwqe = /*#__PURE__*/React.createElement(BearDiv, dweasdd);
  return asdhwqe;
}
...
function BearList(_ref) {
  ...
  function EndListA(coimswe, indexSort) {
    ...
    switch (typeList) {
      case "div":
        asdpkwe = /*#__PURE__*/React.createElement(BearDiv, endRet);
        break;
      ...
      case "return":
        // asdpkwe = "dict";
        asdpkwe = /*#__PURE__*/React.createElement(BearDiv, _extends({}, itemConfig, {
          obj: listarr
        }));
        break;
  ...
  function HozBar() {
    ...
    /*#__PURE__*/
    //
    React.createElement(BearDiv, okadwe); // "okafsdf";
    // EndListA();
    // mapoBap();
  ...
  var sadfwe = //
  // "oaksdwqew";
  !listvar ? "" : horizTrue ? /*#__PURE__*/React.createElement(HozBar, null) : listvar.map(mapoBap); // 1TITLE
  ...
  return /*#__PURE__*/React.createElement(BearDiv, saidje);
}
...
function BearEmoji(_ref) {
  ...
  function saokde(_ref2) {
    ...
    //
    // "sodkqeq"
    React.createElement(BearDiv, xdffsd);
    ...
    var aokdwe = _objectSpread2({
      // style:
      obj: /*#__PURE__*/React.createElement(BearDiv, oksaew),
      popConfig: {
        content: sdfiewrw
      }
    }, qweq);
    return /*#__PURE__*/React.createElement(BearDiv, aokdwe);
  }
...
function BearIcon(sdfoger, sdfke) {
  ...
  /*#__PURE__*/
  //
  React.createElement(AiOutlineCloseCircle, null); // 1comment
...
function BearInput(_ref) {
  ...
  function retFunc() {
    switch (inputType) {
      case "select":
        ...
        ujsdqwe = /*#__PURE__*/React.createElement(Controller, _extends({
          as: ujsdqwe
      ...
      case "checkbox":
        ...
        var dsf9jewr = /*#__PURE__*/React.createElement(BearDiv, ijasdwe);
  ...
  function TitleOBbi() {
    ...
    var aokdwe = //
    ijdsew ? /*#__PURE__*/React.createElement(BearDiv, _extends({
      spanTrue: true
    }, ijweq)) : "";
    var olbknfr = {
      fontSize: "0.7em",
    ...
    var bnkifg = /*#__PURE__*/React.createElement(BearDiv, _extends({
      spanTrue: true
    }, asdwe)); // TITLE MAIN

    var okasde = //
    newTrue ? /*#__PURE__*/React.createElement(ChooseTit, null) : BearIcon(iconvar, titlevar); //         {iconvar} {titlevar}
    ...
    function BswTi() {
      ...
      var dfigjrt = /*#__PURE__*/React.createElement(BearDiv, cvobkof);
      var kcmdr = {
        centerobj: ioakawe,
        rightobj: dfigjrt
      };
    ...
    React.createElement(BearDiv, asdojwqs);
    ...
    function Subtoter() {
      ...
      var uiajwe = /*#__PURE__*/React.createElement(BearDiv, okawe);
      return uiajwe;
    }
    ...
    return /*#__PURE__*/React.createElement(BearDiv, isawqe);
  }
...
function BearForm(_ref) {
  ...
  function Buttiona(_ref2) {
    ...
    return /*#__PURE__*/React.createElement(BearDiv, asidja);
  }
  ...
  function FormError(textvar) {
    ...
    var dfbokerr = /*#__PURE__*/React.createElement(BearDiv, okaease);
    return dfbokerr;
  }
  ...
  function Tabios() {
    ...
    function aidsjfew(_ref6) {
      ...
      var lpsda = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(BearDiv, okawe), titlevar);
  ...
  function Titren(_ref7) {
    ...
    var noisae = /*#__PURE__*/React.createElement(BearDiv, kjase);
    return noisae;
  }
...
export { BearButton, BearCarousel, BearDiv, BearDuration, BearEmoji, BearFloat, BearForm, BearList, BearSelect, logFuncs as logs };
